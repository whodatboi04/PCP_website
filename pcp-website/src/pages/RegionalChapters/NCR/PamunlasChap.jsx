...
import '../../../components/css/ChapterCss/PamunlasChap.css'

export default function PamunlasChap({props}) {
  return (
    <div className='pamunlas-containter'>
      <h1>PAMUNLAS CHAPTER</h1>
      <h3>( Parañaque, Muntinlupa, Las Piñas )</h3>
      <div className='pamunlas-content'>
        <div className='pamunlas-info'>
        ...
        {props.map((officers) => (
        <div className='pamunlas-officers' key={officers.id}>
            <div className='pamunlas-main-table'>
              <h4>OFFICERS</h4>
              <table className='pamunlas-officer-table'>
                <tr>
                  <th>President : </th>
